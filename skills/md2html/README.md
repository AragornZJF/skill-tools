# md2html · 你的Markdown文档，值得被有品味的分享

> 对 AI 说一句"markdown转html"，它不会直接糊一张"一眼 AI 生成"的网页给你--而是先给 4 种截然不同的设计方向让你挑选，你挑选中（或混搭几种）后再落成一份精致的可预览的网页。

---

## md2html 技能它能帮你做什么

使用此技能，把一篇 Markdown、一段想法、一份文档，变成**打开就能看、能复制、能分享**的网页。和直接让 AI"写个 HTML"不一样的地方：
